...
PeterPaul.chem.nutrients.surface <- PeterPaul.chem.nutrients %>% filter(depth == 0)
ggplot(PeterPaul.chem.nutrients.surface, aes(x= daynum, y = temperature_C, col=year4)) +
  geom_point() +
...
ggplot(PeterPaul.chem.nutrients, aes(x= sampledate, y = temperature_C, col=depth)) +
  geom_point(size = 0.5) +
...
ggplot(EPAair, aes(x = PM2.5, y = Ozone, col = meanLat, alpha=0.5)) +
  geom_point() +
