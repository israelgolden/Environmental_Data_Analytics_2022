...
#Get the data, which starts on line 30
gage_data2 <- read.table(theURL,skip = 28,header=TRUE,sep='\t') 
...
```{r}
#Apply the API key
census_api_key("3648b818694a505c4d302267d04fa37ba94a0201", install = TRUE)
...
scrape.it <- function(the_year){
  ...
  the_url <- ifelse(the_year==2020,
                    'https://www.eia.gov/electricity/state/',
gsub('2019',the_year,'https://www.eia.gov/electricity/state/archive/2019/'))
#1 Link to the web site using read_html
