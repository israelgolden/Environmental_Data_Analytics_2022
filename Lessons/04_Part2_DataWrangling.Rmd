...
NTL.nutrient.data.challenge <- select(NTL.nutrient.data.PeterPaul, lakename:sampledate, depth:po4)
```
...
# use logical operator !is.na to remove na values. 
NTL.nutrient.data.PeterPaul.gathered <- subset(NTL.nutrient.data.PeterPaul.gathered, !is.na(concentration))
count(NTL.nutrient.data.PeterPaul.gathered, nutrient) #count how many observations for each nutrient
