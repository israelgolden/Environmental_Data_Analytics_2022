...
library(cowplot)
#load data
PeterPaul.chem.nutrients <- read.csv("./Data/Processed/NTL-LTER_Lake_Chemistry_
                                     Nutrients_PeterPaul_Processed.csv",
                                     stringsAsFactors = TRUE)
NEON.litter <- read.csv("../Data/Processed/NEON_NIWO_Litter_mass_trap_Processed.csv")
